    ...
    TransportSessionProtocol
{
    ...
    // Session parameters
    fileprivate let serviceType = "omg"
    ...
    public var playersNumber: Int = 1
    ...
    public init(userName: String) {
        let safeName = userName.isEmpty ? "Transport session received empty name" : userName
        peerName = safeName
        ...
        print("Transport session created succesfully with username: \(safeName)")
    }
